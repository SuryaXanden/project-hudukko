...
{
	if( ($_GET['price'] < 0 ) || ( strlen($_GET['prod']) < 2 ))//Safety checks
	{
		die();
	}
...
//---Alteration Ends---
	...
	while($result = mysqli_fetch_assoc($query))
	{
		...
		echo "\"" . ucwords($result['company']) ."\":\"" . $result['ql'];
...
else
{
	...
	Example: <a href=\"http://www.hudukko.epizy.com/ipapi/index.php?prod=shoes&price=1000\">http://www.hudukko.epizy.com/ipapi/index.php?prod=shoes&price=1000</a>
	";
}
?>
